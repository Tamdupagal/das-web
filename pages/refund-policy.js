...
<>
<Head>
<title>Refund Policy | Digitalaidedschool </title>
...
<meta name='description' content='For refund policy, read the all instructions here.' />
<meta name="viewport" content="width=device-width, initial-scale=1"/>
<link rel='icon' href='/favicon.png' /> 
</Head>
<div style={{backgroundColor:'#fffef8'}}>
<div style={{textAlign: 'center',paddingTop:'20rem',paddingBottom:'10rem'}}>
<h1 style={{fontSize:'3rem',color:'#fd7e14'}}>100% Refund policy No questions asked.</h1>
</div>
<hr/>
</div>
</> )
