...
const faq = ({name}) => {
  return (
    ...
    <meta name='description' content='Get answers to all your queries regarding the game development courses. Read the FAQs about different live online courses offered by Digitalaidedschool.' />
