...
import intro from '../../assets/post-images/tip.png'
import first from '../../assets/post-images/tipfr.png'
import second from '../../assets/post-images/tipsec.png'
import third from '../../assets/post-images/tipth.png'
import four from '../../assets/post-images/tipthank.png'
...
const Post2 = () => {
  return (
    ...
    <div className='imgg'> 
    <Image src={intro} alt='intro'  className='imgg' />
    </div>
    ...
    <div className='imgg'> 
      ...
      <div className='imgg'> 
    <Image src={first} alt='intro'  className='imgg' />
    </div>
...
<div className='imgg'> 
    <Image src={second} alt='intro'  className='imgg' />
    </div>
...
<div className='imgg'> 
    <Image src={third} alt='intro'  className='imgg' />
    </div>
...
<div className='imgg'> 
    <Image src={four} alt='intro'  className='imgg' />
    </div>
