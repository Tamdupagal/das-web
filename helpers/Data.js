  ...
  return {
    featureDM: [
      ...
      },
      {
        ...
        altText: 'Project',
        title: 'Project',
        text: ['8+ Live Projects.', 'Real Life industry-standard projects'],
      },
      {
        id: 4,
        imgSrc: certify,
      ...
      dm: [
        {
          ...
          title: 'DM Basics ',
          text: [
            'Learn Digital Marketing from Basics.',
      ...
      web: [
        {
          ...
          text: [
            'Learn Programming & logic behind them from Basics.',
            'Industry-specific R&D',
          ],
        },
        {
          ...
          text: [
            'Create a Website around a brand',
            'Learn to create a website with your preferred programming Language.',
          ],
        },
        {
          id: 3,
          ...
          text: [
            'Learn to acquire the skills to develop complete Ecommerce needs.',
        ...
        },
        {
          ...
          text: [
            'Learn how Frontend TECH works ',
            'Learn to Design Frontend tech of web application',
            'Understand Software & Application Design & technology.',
            'Learn how Frontend TECH works',
          ],
        },
        {
          ...
          text: [
            'Learn how Backend TECH works .',
            'Learn to Design Backend tech of web application',
            'Host and run web application.',
          ],
        },
        {
          id: 6,
