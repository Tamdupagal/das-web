...
const LeadForm = ({ close }) => {
  ...
  //    onChange={(e) =>
  //      setDetails((prev) => ({ ...prev, qualification: e.target.value }))
  //    }
      ...
      <div className={styles.form__wrapper}>
        <div style={{ backgroundColor: "white", padding: "10px" }}>
          ...
          <div style={{ paddingTop: "50px", marginLeft: "16px" }}>
            <h2 style={{ fontSize: "27px", color: "#FD7E14" }}>
              DIGITAL AIDED SCHOOL
            </h2>
            <h4
              style={{ fontSize: "18px", color: "#005778", marginTop: "5px" }}
            >
              Hiring Partnership
            </h4>
          </div>
          ...
          >
            ...
            <div className={styles.form__area}>
              ...
              <div className={styles.form__input}>
                <label htmlFor="qualification">Comapany Name</label>
                <div tabIndex={0} className={styles.input__box}>
                  <input
                    type="name"
                    name="username"
